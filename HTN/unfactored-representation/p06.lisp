...
(:task deliver_box box6 area6)
(:task deliver_box box3 area39)
(:task deliver_box box2 area27)
(:task deliver_box box4 area24)
(:task deliver_box box7 area35)
(:task deliver_box box1 area21)
(:task get_picture disaster6)
(:task deliver_box box5 area20)
(:task deliver_sample cdm1 area32)
(:task deliver_sample cdm4 area2)
(:task deliver_sample cdm3 area40)
(:task deliver_sample cdm4 area22)
(:task deliver_sample cdm2 area7)
(:task deliver_sample cdm3 area28)
(:task deliver_sample cdm1 area26)
))

(find-plans 'p06 :verbose :plans)

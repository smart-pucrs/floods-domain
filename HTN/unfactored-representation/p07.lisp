...
(:task deliver_box box7 area30)
(:task deliver_box box5 area20)
(:task get_picture disaster6)
(:task deliver_box box4 area6)
(:task deliver_box box3 area34)
(:task deliver_box box6 area44)
(:task deliver_box box2 area28)
(:task deliver_box box1 area24)
(:task deliver_box box8 area40)
(:task deliver_sample cdm5 area2)
(:task deliver_sample cdm1 area41)
(:task deliver_sample cdm5 area34)
(:task deliver_sample cdm4 area8)
(:task deliver_sample cdm3 area17)
(:task get_picture disaster5)
(:task deliver_sample cdm3 area44)
(:task deliver_sample cdm1 area29)
(:task deliver_sample cdm2 area6)
))

(find-plans 'p07 :verbose :plans)

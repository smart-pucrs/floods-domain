...
(:task get_picture disaster13)
(:task get_picture disaster10)
(:task get_picture disaster15)
(:task get_picture disaster1)
(:task get_picture disaster7)
(:task get_picture disaster2)
(:task get_picture disaster5)
(:task get_picture disaster14)
(:task get_picture disaster12)
(:task get_picture disaster8)
(:task get_picture disaster16)
(:task get_picture disaster4)
(:task get_picture disaster6)
(:task deliver_box box8 area21)
(:task get_picture disaster3)
(:task deliver_box box3 area39)
(:task deliver_box box2 area33)
(:task deliver_box box1 area29)
(:task deliver_box box10 area18)
(:task deliver_box box9 area15)
(:task deliver_box box7 area7)
(:task deliver_box box4 area54)
(:task deliver_box box5 area6)
(:task deliver_box box6 area31)
(:task deliver_sample cdm5 area33)
(:task deliver_sample cdm3 area17)
(:task deliver_sample cdm1 area37)
(:task deliver_sample cdm3 area2)
(:task get_picture disaster9)
(:task deliver_sample cdm2 area35)
(:task deliver_sample cdm6 area56)
(:task get_picture disaster11)
(:task deliver_sample cdm4 area8)
(:task deliver_sample cdm6 area4)
(:task deliver_sample cdm1 area40)
(:task deliver_sample cdm5 area28)
))

(find-plans 'p10 :verbose :plans)

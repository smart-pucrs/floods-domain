...
(:task deliver_box box2 area44)
(:task deliver_box box3 area48)
(:task get_picture disaster12)
(:task deliver_box box7 area8)
(:task deliver_box box9 area13)
(:task deliver_box box5 area50)
(:task deliver_box box8 area51)
(:task deliver_box box1 area41)
(:task deliver_box box4 area3)
(:task deliver_box box10 area55)
(:task deliver_box box6 area33)
(:task deliver_sample cdm3 area12)
(:task deliver_sample cdm6 area38)
(:task deliver_sample cdm2 area36)
(:task deliver_sample cdm6 area54)
(:task deliver_sample cdm5 area1)
(:task deliver_sample cdm1 area48)
(:task deliver_sample cdm3 area50)
(:task deliver_sample cdm4 area19)
(:task deliver_sample cdm1 area30)
(:task deliver_sample cdm5 area28)
))

(find-plans 'p09 :verbose :plans)
